...
import View.ViewCarte;
import View.ViewEcranEnclos;
import View.ViewHandler;
import javafx.event.EventHandler;
import javafx.scene.input.MouseEvent;

public class ControllerCarte implements EventHandler<MouseEvent> {

    private ViewCarte vue;
    private ViewEcranEnclos vueEnclos;
    private ViewHandler vh;

    public ControllerCarte(ViewCarte viewCarte, ViewHandler vh, ViewEcranEnclos vee) {
        this.vue = viewCarte;
        this.vh = vh;
        this.vueEnclos = vee;
    }
