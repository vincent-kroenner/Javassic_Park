...
import Controller.ControllerGestionEnclos;
import Tools.Path;
...
public class ViewGestionEnclos {
    private final ControllerGestionEnclos controllerGestionEnclos;
    private final Group root;

    private ImageView imgBg, imgBg2;
    public static GridPane grid;

    private TextField scenetitlegestion;
    public Button affecterSoigneur, affecterDino, retour;
    ...
    public ViewGestionEnclos(Group root, ViewHandler vh,ViewEcranEnclos vee) {
        this.root = root;
        this.controllerGestionEnclos = new ControllerGestionEnclos(this, vh,vee);
        initBackground();
        initPage();
        initCarte();
    }
    ...
    private void initPage() {
        ...
        scenetitlegestion = new TextField("Menu de gestion des enclos");
        scenetitlegestion.setFont(policeTitre);
        scenetitlegestion.setStyle(appTitre);
        scenetitlegestion.setEditable(false);
        scenetitlegestion.setPrefWidth(largeurEcran * 0.4);

        affecterSoigneur = new Button("Affecter les soigneurs");
        HBox affecterSoigneurBtn = new HBox(20);
        affecterSoigneurBtn.setAlignment(Pos.CENTER);
        affecterSoigneurBtn.getChildren().add(affecterSoigneur);
        affecterSoigneur.setOnMouseClicked(controllerGestionEnclos);
        affecterSoigneur.setFont(fontButton);
        affecterSoigneur.setStyle("-fx-background-color: #E7D832ee;");

        affecterDino = new Button("Affecter les dinos");
        HBox affecterDinoBtn = new HBox(20);
        affecterDinoBtn.setAlignment(Pos.CENTER);
        affecterDinoBtn.getChildren().add(affecterDino);
        affecterDino.setOnMouseClicked(controllerGestionEnclos);
        affecterDino.setFont(fontButton);
        affecterDino.setStyle("-fx-background-color: #E7D832ee;");

        retour = new Button("Retour");
        HBox retourBtn = new HBox(20);
        retourBtn.setAlignment(Pos.BOTTOM_RIGHT);
        retourBtn.getChildren().add(retour);
        retour.setOnMouseClicked(controllerGestionEnclos);
        retour.setFont(fontButton);
        retour.setStyle("-fx-background-color: #E7D832ee;");

        //Position dans la grille
        grid.add(scenetitlegestion, 1, 1, 3, 1);
        grid.add(affecterSoigneurBtn, 3, 4);
        grid.add(affecterDinoBtn, 3, 6);
        grid.add(retourBtn, 1, 10, 3, 1);
    }
    ...
    private void initCarte() {
        ...
        voliere.setOnMouseClicked(controllerGestionEnclos);
        ...
        aquarium.setOnMouseClicked(controllerGestionEnclos);
        ...
        infirmerie.setOnMouseClicked(controllerGestionEnclos);
        ...
        sud1.setOnMouseClicked(controllerGestionEnclos);
        ...
        sud2.setOnMouseClicked(controllerGestionEnclos);
        ...
        sud3.setOnMouseClicked(controllerGestionEnclos);
        ...
        ouest1.setOnMouseClicked(controllerGestionEnclos);
        ...
        ouest2.setOnMouseClicked(controllerGestionEnclos);
        ...
        nord1.setOnMouseClicked(controllerGestionEnclos);
        ...
        nord2.setOnMouseClicked(controllerGestionEnclos);
        ...
        nord3.setOnMouseClicked(controllerGestionEnclos);
        ...
        est1.setOnMouseClicked(controllerGestionEnclos);
        ...
        est2.setOnMouseClicked(controllerGestionEnclos);
        ...
        est3.setOnMouseClicked(controllerGestionEnclos);
        ...
        qg.setOnMouseClicked(controllerGestionEnclos);
        ...
        quitter.setStyle("-fx-background-color: none;" +
                ...
                "-fx-text-fill: red;");
        quitter.setOnMouseClicked(controllerGestionEnclos);
    ...
    public Button getAffecterSoigneur() {
        return affecterSoigneur;
    }

    public Button getAffecterDino() {
        return affecterDino;
    }
