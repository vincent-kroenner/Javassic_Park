...
import Controller.ControllerCarte;
import Tools.Path;
...
public class ViewCarte {
    ...
    public ViewCarte(Group root, ViewHandler vh, ViewEcranEnclos vee) {
        this.root = root;
        this.controllerCarte = new ControllerCarte(this, vh, vee);
        initBackground();
        initTexts();
        initButtons();
    }
    ...
    private void initTexts() {
        texteUtilisation = new Text("Cliquez sur les icones \n de la carte pour \n naviguer dans le menu ");
        texteUtilisation.setFill(Color.YELLOW);
        texteUtilisation.setStyle("-fx-background-color: none;" +
                "-fx-effect : dropshadow(two-pass-box, black, 6, 2, 2, 2);");
        Font policeTitre = Font.loadFont(getClass().getResourceAsStream(Path.fontHeadCase), largeurEcran * 0.07);
        texteUtilisation.setFont(policeTitre);
        texteUtilisation.setTranslateX(largeurEcran * 0.1);
        texteUtilisation.setTranslateY(hauteurEcran * 0.4);
    }
    ...
    private void initButtons() {
        ...
        voliere.setOnMouseClicked(controllerCarte);
        ...
        aquarium.setOnMouseClicked(controllerCarte);
        ...
        infirmerie.setOnMouseClicked(controllerCarte);
        ...
        sud1.setOnMouseClicked(controllerCarte);
        ...
        sud2.setOnMouseClicked(controllerCarte);
        ...
        sud3.setOnMouseClicked(controllerCarte);
        ...
        ouest1.setOnMouseClicked(controllerCarte);
        ...
        ouest2.setOnMouseClicked(controllerCarte);
        ...
        nord1.setOnMouseClicked(controllerCarte);
        ...
        nord2.setOnMouseClicked(controllerCarte);
        ...
        nord3.setOnMouseClicked(controllerCarte);
        ...
        est1.setOnMouseClicked(controllerCarte);
        ...
        est2.setOnMouseClicked(controllerCarte);
        ...
        est3.setOnMouseClicked(controllerCarte);
        ...
        qg.setOnMouseClicked(controllerCarte);
        ...
        quitter.setStyle("-fx-background-color: none;" +
                "-fx-effect : dropshadow(two-pass-box, black, 6, 2, 2, 2);" +
                "-fx-text-fill: red;");
        quitter.setOnMouseClicked(controllerCarte);
    ...
    public void setVueForm() {
        ...
        root.getChildren().add(texteUtilisation);
    ...
    public Button getSud2() { return sud2; }
