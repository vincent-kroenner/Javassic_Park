...
public class BDDManager2 {
    ...
    /*private final String BDD_URL = "jdbc:mysql://localhost:3306/javassicpark";
...
public boolean test(String maRequete){
    ...
    public ArrayList<ArrayList<String>> select(String maRequete) {
        ...
        try
        {
            ...
            while(rs.next()) // tant qu'il y a des lignes à lire
            {
                ...
                i++;
            } System.out.println(resultatDeLaRequete);
        }
    ...
    public static void main(String[] args) {
        ...
        bdd.lire("src/BDD_Javassicpark.sql");
        bdd.stop();
    }
}